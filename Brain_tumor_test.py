...
input_size = 64
#image= cv2.imread('Brain Tumor Data Set\\Brain Tumor Data Set\\prediction\\Y10.jpg')
...
print(predictions)
# Convert probabilities to class indices (assuming it's a classification problem)
